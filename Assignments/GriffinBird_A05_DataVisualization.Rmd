...
phos.plot <- ggplot(PeterPaul.data, aes(x = po4, y = tp_ug, color = lakename)) + 
  xlim(0, 50) +
  labs(title = "Phosphorus by Phosphate for Peter Lake and Paul Lake",
       x = "Phosphate (PO4)",
       y = "Phosphorus") +
...
TP.plot <- ggplot(PeterPaul.data, aes(x = sampledate, y = temperature_C, color = lakename)) + 
  labs(title = "Phosphorus by Phosphate for Peter Lake and Paul Lake",
       x = "Phosphate (PO4)",
       y = "Phosphorus") +
  geom_boxplot()

TN.plot <- ggplot(PeterPaul.data, aes(x = sampledate, y = temperature_C, color = lakename)) + 
  labs(title = "Phosphorus by Phosphate for Peter Lake and Paul Lake",
       x = "Phosphate (PO4)",
       y = "Phosphorus") +
  geom_boxplot()
