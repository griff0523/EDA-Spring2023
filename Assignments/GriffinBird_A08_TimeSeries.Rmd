...
GaringerOzone.daily.ts <- ts(GaringerOzone_Interp$Daily8hrMax, start = c(2010,1), end = c(2020), frequency=365)

GaringerOzone.monthly.ts <- ts(GaringerOzone.monthly$Daily8hrMax.Mean, start = c(2010,1), end = c(2019, 12), frequency=12)
...
```{r}
#15
GaringerOzone.monthly.ts.Components <- as.data.frame(GaringerOzone.monthly.ts_decomposed$time.series[,1:3])
